...
class MaskType(EffectEnum):
    ...
    矩形 = MaskMeta("矩形", "rectangle", "7356934318301647410", "636077", "ef361d96c456cd6077c76d737f98898d", 1.0)
    爱心 = MaskMeta("爱心", "heart", "7416258912162157068", "636079", "0bf09fa1e3a32464fed4f71e49a8ab01", 1.1148148148)
    文字 = MaskMeta("文字", "text", "7434089085267874314", "", "", 1.0)
