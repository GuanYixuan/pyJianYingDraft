...
> **关于6+版本**：剪映对`draft_content.json`文件进行了加密，但**仍兼容本项目除模板模式外的所有功能**

> **关于7+版本**：剪映隐藏了窗口控件，因而导致目前的**批量导出功能失效**
...
> ⚠️ 本部分功能依赖于`uiautomation`库，故目前**仅支持在Windows系统下运行**；此外**剪映7+版本**疑似对控件进行了隐藏，可能导致本功能失效
